...
namespace spline{
    ...
    void BSplineEvaluator::eval(void* mem, const double** arg, double** res, int* iw, double* w) const {
    ...
    : UnivariateBasisNode(degree), bspline_evaluator_(BSplineEvaluator::create("f", knots.size(), degree) ), knots_(knots) { }
