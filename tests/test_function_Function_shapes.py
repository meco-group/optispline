...
#        self.assertEqualT(func3(0.5),DTensor([func1(0.5),0,0,func2(0.5)],[2,2]))
#        func4 = func1.blkdiag(DTensor([],[2,0]))
#        self.assertEqual(func4.shape(),[3,1])
#        self.assertEqualT(func4(0.5),DTensor([func1(0.5),0,0],[3,1])
#        func5 = func1.blkdiag(DTensor([2,3],[1,2]))
#        self.assertEqual(func5.shape(),[2,3])
#        self.assertEqualT(func5(0.5),DTensor([func1(0.5),0,0,2,0,3],[2,3])
